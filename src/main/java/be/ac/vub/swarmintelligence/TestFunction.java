...
public class TestFunction {
	...
	// ,int) /* Bent_Cigar */
	// double discus_func_func (double[] , double , int , double[] ,double[]
	// ,int ,int) /* Discus */
	...
	// ,int) /* Rosenbrock's */
	// double schaffer_F7_func (double[] , double , int , double[] ,double[]
	// ,int ,int) /* Schwefel's F7 */
	...
	// ,int) /* Katsuura */
	// double bi_rastrigin_func (double[] , double , int , double[] ,double[]
	// ,int ,int) /* Lunacek Bi_rastrigin */
	...
	// double step_rastrigin_func (double[] , double , int , double[] ,double[]
	...
	// double cf01 (double[] , double[] , int , double[] ,double[] , double[]
	// ,int ) /* Composition Function 1 */
	// double cf02 (double[] , double[] , int , double[] ,double[] ,double[]
	// ,int ) /* Composition Function 2 */
	// double cf03 (double[] , double[] , int , double[] ,double[] ,double[]
	// ,int ) /* Composition Function 3 */
	// double cf04 (double[] , double[] , int , double[] ,double[] ,double[]
	// ,int ) /* Composition Function 4 */
	// double cf05 (double[] , double[] , int , double[] ,double[] ,double[]
	// ,int ) /* Composition Function 5 */
	// double cf06 (double[] , double[] , int , double[] ,double[] ,double[]
	// ,int ) /* Composition Function 6 */
	// double cf07 (double[] , double[] , int , double[] ,double[] ,double[]
	...
	void test_func(double[] x, double[] f, int nx, int mx, int func_num) throws Exception {
		...
		if (ini_flag == 1) {
			if ((n_flag != nx)
					|| (func_flag != func_num)) /*
												 * check if nx or func_num are
												 * changed, reinitialization
												 */
			{
				ini_flag = 0;
			}
		...
		if (ini_flag == 0) /* initiailization */
		{
			...
			if (nx == 2
					&& ((func_num >= 6 && func_num <= 8) || (func_num == 10) || (func_num == 13))) {
			 ...
			 * Load Matrix M
			 *****************************************************/
			File fpt = new File(classLoader
					.getResource("input_data/M_" + func_num + "_D" + nx + ".txt").getFile());// *
																								// Load
																								// M
																								// data
																								// *
			...
			/*
			 * if (func_num<9) { M=new double[nx*nx];
			 * 
			 * for (i=0;i<nx*nx; i++) { M[i]=input.nextDouble(); } } else {
			 * M=new double[cf_num*nx*nx];
			 * 
			 * for (i=0; i<cf_num*nx*nx; i++) { M[i]=input.nextDouble(); }
			 * 
			 * }
			 */
			 ...
			 * if (func_num>=9){
			 * 
			 * fpt = new File("input_data/bias_"+func_num+".txt");//* Load bias
			 * data * input = new Scanner(fpt); if (!fpt.exists()) {
			 * System.out.println(
			 * "\n Error: Cannot open input file for reading "); }
			 * 
			 * bias=new double[cf_num];
			 * 
			 * for (i=0;i<cf_num; i++) { bias[i]=input.nextDouble(); }
			 * input.close(); }
			 */
			...
			if (cf_num > 1) {
				...
				fpt = new File(
						classLoader.getResource("input_data/bias_" + func_num + ".txt").getFile());// *
																									// Load
																									// bias
																									// data
																									// *
			...
			fpt = new File(classLoader.getResource("input_data/shift_data_" + func_num + ".txt")
					.getFile());
			input = new Scanner(fpt);
			if (!fpt.exists()) {
				System.out.println("\n Error: Cannot open input file for reading ");
			...
			/*
			 * for(i=0;i<cf_num*nx;i++) { OShift[i]=input.nextDouble();
...
//					String sss = input.nextLine();
			...
			/*
			 * if (func_num<9) { fpt=new
			 * File("input_data/shift_data_"+func_num+".txt"); input = new
			 * Scanner(fpt); if (!fpt.exists()) { System.out.println(
			 * "\n Error: Cannot open input file for reading "); }
			 * 
			 * OShift=new double[nx]; for(i=0;i<nx;i++) {
			 * OShift[i]=input.nextDouble(); if (OShift == null) {
			 * System.out.println(
			 ...
			 * FileReader reader = new FileReader(fpt); BufferedReader br = new
			 * BufferedReader(reader); String[] s = new String[100];
			 * 
			 * for (i=0;i<cf_num;i++){ s[i] = br.readLine(); String[] array =
			 * s[i].split("\\s+"); double[] temp = new double[array.length-1];
			 * 
			 * for ( int k = 0; k < array.length-1; k++) { temp[k]=
			 * Double.parseDouble(array[k+1]);
			 * 
			 * }
			 * 
			 * for (j=0;j<nx;j++){
			 ...
			 * }
			 * 
			 * br.close(); reader.close(); input.close();
			 * 
			 * 
			 * }
			 * 
			...
			if (bShuffle[func_num] == 1) {
				fpt = new File(classLoader
						.getResource("input_data/shuffle_data_" + func_num + "_D" + nx + ".txt")
						.getFile());
				input = new Scanner(fpt);
				if (!fpt.exists()) {
					System.out.println("\n Error: Cannot open input file for reading ");
			...
			/*
			 * if (func_num>=6&&func_num<=8) { fpt = new
			 * File("input_data/shuffle_data_"+func_num+"_D"+nx+".txt");
			 * //sprintf(FileName, "input_data/shuffle_data_%d_D%d.txt",
			 * func_num, nx); //fpt = fopen(FileName,"r"); input = new
			 * Scanner(fpt); if (!fpt.exists()) { System.out.println(
			 * "\n Error: Cannot open input file for reading "); }
			 * 
			 * //SS=(int *)malloc(nx*sizeof(int)); SS = new int[nx];
			 * 
			 * for(i=0;i<nx;i++) { //fscanf(fpt,"%d",&SS[i]); SS[i] =
			 * input.nextInt(); } } else if (func_num==10||func_num==13) {
			 * //sprintf(FileName, "input_data/shuffle_data_%d_D%d.txt",
			 * func_num, nx); fpt = new
			 * File("input_data/shuffle_data_"+func_num+"_D"+nx+".txt"); //fpt =
			 * fopen(FileName,"r"); input = new Scanner(fpt); if (!fpt.exists())
			 * { System.out.println(
			 * "\n Error: Cannot open input file for reading "); }
			 * 
			 * //SS=(int *)malloc(nx*cf_num*sizeof(int)); SS = new
			 * int[nx*cf_num];
			 * 
			 * for(i=0;i<nx*cf_num;i++) { //fscanf(fpt,"%d",&SS[i]); SS[i] =
	...
	double discus_func(double[] x, double f, int nx, double[] Os, double[] Mr, int s_flag,
			int r_flag) /* Discus */
	{
		int i;
		sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag);/* shift and rotate */
	...
	double ackley_func(double[] x, double f, int nx, double[] Os, double[] Mr, int s_flag,
			int r_flag) /* Ackley's */
	{
		int i;
		double sum1, sum2;
			...
			int r_flag) /* Weierstrass's */
	{
		...
		sr_func(x, z, nx, Os, Mr, 0.5 / 100.0, s_flag,
				r_flag);/* shift and rotate */
			...
			int r_flag) /* Schwefel's */
	{
		...
		for (i = 0; i < nx; i++) {
			...
			if (z[i] > 500) {
				...
				f -= (-500.0 + (Math.abs(z[i]) % 500))
						* Math.sin(Math.pow(500.0 - (Math.abs(z[i]) % 500), 0.5));
				tmp = (z[i] + 500.0) / 100;
				f += tmp * tmp / nx;
			} else
			...
			int r_flag) /* Katsuura */
	{
		...
		sr_func(x, z, nx, Os, Mr, 5 / 100.0, s_flag,
				r_flag);/* shift and rotate */
	...
	/* original global optimum: [-1,-1,...-1] */
	{
		...
		f = Math.pow(Math.abs(Math.pow(r2, 2.0) - Math.pow(sum_z, 2.0)), 2 * alpha)
				+ (0.5 * r2 + sum_z) / nx + 0.5;
		return f;
	...
	void sr_func(double[] x, double[] sr_x, int nx, double[] Os, double[] Mr, double sh_rate,
	...
	double cf_cal(double[] x, double f, int nx, double[] Os, double[] delta, double[] bias,
			double[] fit, int cf_num) {
		int i, j;
